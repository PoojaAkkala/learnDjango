...
from products.views import product_list_view,product_detail_view,product_create_view,dynamic_lookup_view,product_delete_view
urlpatterns = [
    ...
    path('productlist/', product_list_view, name='about'),
